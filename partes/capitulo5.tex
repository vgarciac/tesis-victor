...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:blend-a}\includegraphics[width=.48\textwidth]{blend-types-1}}
	\subfigure[]{\label{fig:blend-b}\includegraphics[width=.48\textwidth]{blend-types-2}}
	\vspace{-0.3cm}
	
	\subfigure[]{\label{fig:blend-c}\includegraphics[width=.5\textwidth]{blend-types-3}}
