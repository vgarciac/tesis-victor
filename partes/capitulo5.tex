...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:color:espenky-a}\includegraphics[width=0.75\textwidth]{resultados/color/espenky-no.jpg}}
	\subfigure[]{\label{fig:color:espenky-b}\includegraphics[width=0.75\textwidth]{resultados/color/espenky-si.jpg}}
...
A continuación se presentan los resultados del algoritmo descrito en la sección \ref{seccion-fusion}. Ya se ha observado como los algoritmos presentados anteriormente logran solventar la mayoría de inconvenientes y errores de alineación en las imágenes. \begin{figure}[H]
	\centering
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:blend:laplacian-a}\includegraphics[width=0.36\textwidth]{resultados/blend/canny00.jpg}}
	\subfigure[]{\label{fig:blend:laplacian-b}\includegraphics[width=0.36\textwidth]{resultados/blend/canny09.jpg}}
...
A continuación se presentan resultados para un conjunto mayor de imágenes, aplicando en conjunto los algoritmos descritos en el presente trabajo. Para algunos casos se emplean todos los módulos, mientras que en otros se excluyen algunos no necesarios, estos se indicarán en cada resultado.
...
En esta sección se presentan los errores resultantes de las etapas de alineación, y que evitan que se logra un  mosaico que cumpla con el objetivo de aparentar ser una misma imagen. Luego del planteamiento del problema se exponen y describen distintos algoritmos que buscan una solución a estos.
