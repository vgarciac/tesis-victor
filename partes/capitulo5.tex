...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/0233-simple.jpg}}\hspace{0.005\textwidth}%
	\subfigure[]{\label{fig:orange}\includegraphics[width=.45\textwidth]{resultados/cut/0233-mask.jpg}}
	
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/0233-redline.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=.49\textwidth]{resultados/cut/0233-cutline.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/0234-simple.jpg}}\hspace{0.05\textwidth}%
	\subfigure[]{\label{fig:orange}\includegraphics[width=.44\textwidth]{resultados/cut/0234-mask.jpg}}
	
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/0234-redline.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=.49\textwidth]{resultados/cut/0234-cutline.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/geo-simple.jpg}}\hspace{0.1\textwidth}%
	\subfigure[]{\label{fig:orange}\includegraphics[width=.39\textwidth]{resultados/cut/geo-mask.jpg}}
	
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/geo-redline.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=.49\textwidth]{resultados/cut/geo-cutline.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/Espenky-simple.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=.49\textwidth]{resultados/cut/Espenky-redline.jpg}}
	
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/cut/Espenky-cutline.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=.49\textwidth]{resultados/color/geo-no.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=.49\textwidth]{resultados/color/geo-si.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.49\textwidth]{resultados/color/0233-no.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=0.49\textwidth]{resultados/color/0233-si.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.8\textwidth]{resultados/color/espenky-no.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=0.8\textwidth]{resultados/color/espenky-si.jpg}}
