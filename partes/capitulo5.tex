...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.53\textwidth]{resultados/full/0234-0.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=0.53\textwidth]{resultados/full/0234-map.jpg}}
...
\begin{figure}[h]
	...
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.49\textwidth]{resultados/full/SR-map.jpg}}
...
\begin{figure}[h]
	...
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.49\textwidth]{resultados/full/espenky-map.jpg}}\hspace{10mm}%
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.335\textwidth]{resultados/full/espenky-1.jpg}}
