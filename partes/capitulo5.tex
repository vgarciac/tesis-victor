...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:corte:0233-a}\includegraphics[width=.49\textwidth]{resultados/cut/0233-simple.jpg}}\hspace{0.005\textwidth}%
	\subfigure[]{\label{fig:corte:0233-b}\includegraphics[width=.45\textwidth]{resultados/cut/0233-mask.jpg}}
	
	\subfigure[]{\label{fig:corte:0233-c}\includegraphics[width=.49\textwidth]{resultados/cut/0233-redline.jpg}}
	\subfigure[]{\label{fig:corte:0233-d}\includegraphics[width=.49\textwidth]{resultados/cut/0233-cutline.jpg}}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:corte:espenky-a}\includegraphics[width=.49\textwidth]{resultados/cut/Espenky-simple.jpg}}
	\subfigure[]{\label{fig:corte:espenky-b}\includegraphics[width=.49\textwidth]{resultados/cut/Espenky-redline.jpg}}
	
	\subfigure[]{\label{fig:corte:espenky-c}\includegraphics[width=.49\textwidth]{resultados/cut/Espenky-cutline.jpg}}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=1\linewidth]{/resultados/blend/blend-espenky2.pdf}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:apple}\includegraphics[width=0.49\textwidth]{resultados/blend/canny00.jpg}}
	\subfigure[]{\label{fig:orange}\includegraphics[width=0.49\textwidth]{resultados/blend/canny09.jpg}}
