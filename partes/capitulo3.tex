...
\begin{figure}[H]
	\centering
	\includegraphics[width=14cm]{comparacion}
...
\begin{table}[h]
	\centering
	\captionof{table}{Comparación de rendimiento usando imágenes submarinas de Chuspa}
	\label{0234}
...
\begin{table}[h]
	\centering
	\captionof{table}{Comparación de rendimiento usando imágenes submarinas de Chuspa, luego de aplicar estiramiento del histograma}
	\label{0234-2}
	\renewcommand{\arraystretch}{0.8}% Tighter
	\begin{tabular}{@{}lllllll@{}}
		\toprule
...
\begin{figure}[h]
	...
	\end{tabular}
	\captionof{figure}{subconjunto representativo del conjunto de imágenes de Chuspa}
	\label{imagen:0234}
\end{figure}
...
\begin{table}[h]
		\centering
		\captionof{table}{Comparación de rendimiento usando imágenes submarinas de ScottReef}
		\label{SR}
		\renewcommand{\arraystretch}{0.8}% Tighter
		\begin{tabular}{@{}lllllll@{}}
			\toprule
...
\begin{table}[h]
	\centering
	\captionof{table}{Comparación de rendimiento usando imágenes submarinas de ScottReef, luego de aplicar estiramiento del histograma}
	\label{SR-2}
	\renewcommand{\arraystretch}{0.8}% Tighter
	\begin{tabular}{@{}lllllll@{}}
		\toprule
...
\begin{figure}[h]
 	...
 	\captionof{figure}{subconjunto representativo del conjunto de imágenes de ScottReef}
 	\label{imagen:SR}
...
\begin{table}[h]
	\centering
	\captionof{table}{Comparación de rendimiento usando imágenes submarinas de Mochima}
	\label{0752}
	\renewcommand{\arraystretch}{0.8}% Tighter
	\begin{tabular}{@{}lllllll@{}}
		\toprule
...
\begin{table}[h]
	\centering
	\captionof{table}{Comparación de rendimiento usando imágenes submarinas de Mochima, luego de aplicar estiramiento del histograma}
	\label{0752-2}
	\renewcommand{\arraystretch}{0.8}% Tighter
	\begin{tabular}{@{}lllllll@{}}
		\toprule
...
\begin{figure}[h]
	...
	\end{tabular}
	\captionof{figure}{subconjunto representativo del conjunto de imágenes de Mochima}
	\label{imagen:0752}
\end{figure}
