...
\begin{figure}[h]
	...
	\end{tabular}
	\captionof{figure}{imágenes representativas del conjunto de imágenes de Chuspa}
	\label{imagen:0234}
\end{figure}
...
\begin{figure}[h]
 	...
 	\captionof{figure}{imágenes representativas del conjunto de imágenes de ScottReef}
 	\label{imagen:SR}
...
\begin{figure}[h]
	...
	\end{tabular}
	\captionof{figure}{imágenes representativas del conjunto de imágenes de Mochima}
	\label{imagen:0752}
\end{figure}
