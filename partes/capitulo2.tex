...
\begin{figure}
	...
	\subfigure[Clasificación segun el proceso de registro]{\label{fig:vecinos1-a}\includegraphics[width=.45\textwidth]{clasificacion1.pdf}}\hspace{5mm}%}
	\subfigure[Clasificación segun el proceso de fusión]{\label{fig:vecinos1-b}\includegraphics[width=.45\textwidth]{clasificacion2.pdf}}
