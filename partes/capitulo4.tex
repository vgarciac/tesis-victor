...
\subsection{Seguimiento de puntos}\label{secccion-grid}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=.40\textwidth]{resultados/grid/geo-big-1_2.pdf}}\hspace{3mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=.40\textwidth]{resultados/grid/geo-bigG-1_2.pdf}}
...
Para analizar de otra dorma los datos presentados en los histogramas, 
