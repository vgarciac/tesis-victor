...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[width=0.49\textwidth]{resultados/seguimiento/SR-old}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.49\textwidth]{resultados/seguimiento/SR-new}}
...
\begin{figure}[!h]
	...
	\begin{varwidth}{0.49\linewidth}  % this is a must
		\subfigure[Frame 1]{\includegraphics[width=1\linewidth]{resultados/seguimiento/0234-old-match}}\\
		\subfigure[Frame 2]{\includegraphics[width=1\linewidth]{resultados/seguimiento/0234-old}}
	\end{varwidth}
	\begin{varwidth}{0.50\linewidth}  % this is a must
		\subfigure[Frame 3]{\includegraphics[width=1\linewidth]{resultados/seguimiento/0234-new}}
		\color{white}
		\color{black}
	\end{varwidth}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[width=0.29\textwidth]{resultados/vecinos/0752-old}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.29\textwidth]{resultados/vecinos/0752-new}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.29\textwidth]{resultados/vecinos/0752-newmap}}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[width=0.39\textwidth]{resultados/hpromedio/0234-ref1}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.59\textwidth]{resultados/hpromedio/0234-ref2}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.8\textwidth]{resultados/hpromedio/0234-avg}}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[width=0.30\textwidth]{resultados/hpromedio/SR-ref0}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.25\textwidth]{resultados/hpromedio/SR-ref1}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[width=0.30\textwidth]{resultados/hpromedio/SR-avg}}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=0.8\textwidth]{resultados/ec/0234-e}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.8\textwidth]{resultados/ec/0234-emap}}\hspace{1mm}%}
	\caption[Histogramas 1]{Histogramas 1}
	\label{imagen:seg:SR}
\end{figure}
...
\begin{figure}[h]
	...
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.9\textwidth]{resultados/ec/0234-f}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=0.9\textwidth]{resultados/ec/0234-fmap}}\hspace{1mm}%}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.8\textwidth]{resultados/ec/0234-ec}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.8\textwidth]{resultados/ec/0234-ecmap}}
	\caption[Histogramas 1]{Histogramas 1}
	\label{imagen:seg:SR}
\end{figure}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=0.8\textwidth]{resultados/ec/SR-e}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.8\textwidth]{resultados/ec/SR-emap}}\hspace{1mm}%}
	\caption[Histogramas 1]{Histogramas 1}
	\label{imagen:seg:SR}
\end{figure}
...
\begin{figure}[h]
	...
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.9\textwidth]{resultados/ec/SR-f}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=0.9\textwidth]{resultados/ec/SR-fmap}}\hspace{1mm}%}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.8\textwidth]{resultados/ec/SR-ec}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.8\textwidth]{resultados/ec/SR-ecmap}}
	\caption[Histogramas 1]{Histogramas 1}
	\label{imagen:seg:SR}
\end{figure}
