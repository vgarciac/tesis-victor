...
\begin{figure}[h]
	...
	\caption[Distribucion de parejas en imágenes del conjunto \textit{Chuspa}]{DHstribucion de parejas en imágenes del conjunto \textit{Chuspa}}
...
\begin{figure}[h]
	...
	\caption[Distribucion de parejas en imágenes del conjunto \textit{Mochima}]{DHstribucion de parejas en imágenes del conjunto \textit{Mochima}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:ec2-a}\includegraphics[height=0.70\textwidth]{resultados/ec/0234-ec}}\hspace{1mm}%}
	\subfigure[]{\label{fig:ec2-b}\includegraphics[height=0.70\textwidth]{resultados/ec/0234-ecmap}}
	\caption[Histogramas 1]{Histogramas 1}
