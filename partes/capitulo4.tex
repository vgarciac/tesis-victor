...
\begin{figure}[h]
	...
	\caption[Gerenación de sub mosaicos]{Los cuadros verde y rojo son dos sub mosaico temporalmente continuos. El cuadro amarillo se convierte en el rojo relleno por presentar mucha distorsión.}
...
sección \ref{seleccion-grid}. Para esto se estudia tanto analíticamente como visual el resultado de aplicar esta técnica. Estudiaremos el el error de estimar una matriz de homografía sobre la distancia de los puntos correspondientes luego de aplicarla. 
...
\begin{figure}[h]
	...
	\subfigure[]{\label{fig:grid-geo-hist-b}\includegraphics[height=.40\textwidth]{resultados/grid/geo-bigG-1_2.pdf}}
...
\begin{figure}[h]
	...
	\subfigure[]{\label{fig:sub-geo-b}\includegraphics[height=.35\textwidth]{resultados/grid/0752-4_5G.pdf}}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:seg:SR-a}\includegraphics[width=0.35\textwidth]{resultados/seguimiento/SR-old}}\hspace{1mm}%}
	\subfigure[]{\label{fig:seg:SR-b}\includegraphics[width=0.35\textwidth]{resultados/seguimiento/SR-new}}
...
Por otra parte, se presenta un resultado utilizando el conjunto \textit{Chuspa}. Similar al caso anterior, la cantidad de imágenes que se pueden añadir al mosaico utilizando el antiguo método de registro es muy limitada. Esto se puede observar en la figura \ref{fig:seg:0234-b}, ahí se presenta la máxima cantidad de imágenes que fue posible añadir con el antiguo método (6 imágenes), mientras que en la figura \ref{fig:seg:0234-a} se muestran la cantidad de puntos que fue posible relacionar, en este caso el mínimo necesario (4 puntos). 
...
Un mosaico puede estar compuesto por una gran cantidad de sub mosaicos, si bien el proceso para unirlos ya se ilustró, se muestra el criterio para la selección sobre cuales se deben unir en primer lugar. Para esto se selecciona el par se sub mosaicos que presente mayor área de superposición, a medida que se va construyendo. Es importante destacar que cuando se evalúan dos sub mosaicos ya corregidos, se considera la matriz de homografía promedio para determinar el área de superposición.
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{resultados/jerarquia-reducido.pdf}
...
\begin{figure}[H]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=0.60\textwidth]{resultados/ec/0234-e}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.60\textwidth]{resultados/ec/0234-emap}}\hspace{1mm}%}
	\caption[Histogramas 1]{Histogramas 1}
...
\begin{figure}[H]
	...
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.6\textwidth]{resultados/ec/0234-f}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-a}\includegraphics[height=0.6\textwidth]{resultados/ec/0234-fmap}}\hspace{1mm}%}
...
\begin{figure}[h]
	\centering     %%% not \center
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.70\textwidth]{resultados/ec/0234-ec}}\hspace{1mm}%}
	\subfigure[]{\label{fig:hist1-b}\includegraphics[height=0.70\textwidth]{resultados/ec/0234-ecmap}}
	\caption[Histogramas 1]{Histogramas 1}
