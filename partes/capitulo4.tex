...
\begin{figure}
	...
	\caption{En función a la ultima imagen añadida (superior), todas las imágenes con marco de color negro son considerados como vecinos. En el caso de la figura (b) una búsqueda en la que solo se considere la imagen anterior no aprovecha toda la información de aquellas con las que se intersecta}
...
\begin{figure}
	\centering     %%% not \center
	\subfigure[]{\label{fig:a}\includegraphics[width=.29\textwidth]{vecinos3.pdf}}\hspace{5mm}%}
	\subfigure[]{\label{fig:b}\includegraphics[width=.29\textwidth]{vecinos4.pdf}}\hspace{5mm}%
	\subfigure[]{\label{fig:b}\includegraphics[width=.29\textwidth]{vecinos5.pdf}}
	\caption{my caption}
\end{figure}
