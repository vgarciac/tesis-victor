...
\begin{titlepage}
    \title{\vspace{-2cm} \includegraphics[width=1.2in]{./usb.png} \\[.2cm]
        ...
        \vfill \LARGE Sistema de generacion de mosaicos 2D para robots móviles a partir de video monocular  \vfill}
    \author{Por: \\
        Victor Garcia \\[1.2cm]
...
\noindent \begin{small} \textbf{Palabras clave}: Keypoint, @palabra2, @palabra3.
\end{small}
